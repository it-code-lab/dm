...
$plan_details = [
    'basic' => ['price' => 199, 'label' => 'Basic Plan', 'services' => ['onpage_seo', 'meta_ads', 'gmb']],
    'advanced' => ['price' => 399, 'label' => 'Advanced Plan', 'services' => ['onpage_seo', 'meta_ads', 'gmb', 'technical_seo']],
    'pro' => ['price' => 699, 'label' => 'Pro Plan', 'services' => ['onpage_seo', 'meta_ads', 'gmb', 'technical_seo', 'reels', 'email_marketing']],
...
<div class="medium-container">
    ...
    <form id="purchaseForm" action="checkout.php" method="POST" enctype="multipart/form-data">
        ...
        <?php else: ?>            
            ...
            Or <a href="#" onclick="openLoginModal()" class="login-link">log in</a> to place order from your account.
        <?php endif; ?>
...
<div id="authModal" class="modal" style="display:none">
  <div class="modal-content">
    ...
    <div id="authForms" class="medium-container">
      <div id="loginForm">
        <h3>Login</h3>
